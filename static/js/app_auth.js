// RAG Q&A Knowledge Base JavaScript with Authentication
...
class QAAppAuth {
    ...
    async addQA() {
        ...
        try {
            ...
            if (data.success) {
                this.showMessage('addResult', `Q&A pair added successfully by ${data.added_by}!`, 'success');
        ...
        try {
            ...
            statsContent.innerHTML = `
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 2rem;">
                    ...
                    <div class="categories-list">
                        <h3><i class="fas fa-users"></i> User Stats</h3>
                        <div class="category-item">
                        ...
                        <div class="category-item">
                            ...
                            <span class="category-count">${this.currentUser.username}</span>
                        </div>
                    </div>
                </div>
            `;
